...
void Math::registerModule()
{
    Lua::getState().new_usertype<glm::vec2>("Vec2f",
                                            sol::constructors<glm::vec2(), glm::vec2(glm::vec2), glm::vec2(const glm::vec2&), glm::vec2(const glm::uvec2&)>(),
                                            "x", &glm::vec2::x,
                                            "y", &glm::vec2::y,
    ...
    Lua::getState().new_usertype<glm::uvec2>("Vec2u",
                                            sol::constructors<glm::uvec2(), glm::uvec2(glm::uvec2), glm::uvec2(const glm::uvec2&), glm::uvec2(const glm::vec2&)>(),
                                            "x", &glm::uvec2::x,
                                            "y", &glm::uvec2::y,
    ...
    Lua::getState().new_usertype<glm::ivec2>("Vec2i",
                                            sol::constructors<glm::ivec2(), glm::ivec2(glm::ivec2), glm::ivec2(const glm::ivec2&), glm::ivec2(const glm::vec2&)>(),
                                            "x", &glm::ivec2::x,
                                            "y", &glm::ivec2::y,
